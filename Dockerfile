...
#   docker build --build-arg V8_VERSION=6.3.292.48.1 --tag augustoroman/v8-lib:6.3.292.48.1 docker-v8-lib/
...
#   docker build --build-arg V8_VERSION=6.3.292.48.1 -t v8-runjs .
...
#   RUN go get github.com/panchengtao/v8 ||:
# but this allows using any local modifications.
ARG GO_V8_DIR=/go/src/github.com/panchengtao/v8/
